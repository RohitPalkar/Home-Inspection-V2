...
export const PHOTO_GUIDANCE: Record<string, PhotoGuidanceEntry> = {
  ...
  "electrical-panel": {
    ...
    goodExample: {
      src: pgPath("systems", "electrical-panel", "good"),
      ...
      fallbackSrc: [pgPath("systems", "electrical-panel", "good", "jpg")],
    },
    badExample: {
      src: pgPath("systems", "electrical-panel", "bad"),
      alt: "Electrical panel photo that is dark and blurry",
      caption: "Too dark, blurry, breakers not distinguishable.",
      fallbackSrc: [pgPath("systems", "electrical-panel", "bad", "jpg")],
    },
    tips: [
  ...
  "hvac-system": {
    ...
    goodExample: {
      src: pgPath("systems", "hvac-system", "good"),
      ...
      fallbackSrc: [pgPath("systems", "hvac-system", "good", "jpg")],
    },
    badExample: {
      src: pgPath("systems", "hvac-system", "bad"),
      alt: "HVAC system photo that is too close and cluttered",
      caption: "Too close — unit cropped, clutter in frame, poor lighting.",
      fallbackSrc: [pgPath("systems", "hvac-system", "bad", "jpg")],
    },
    tips: [
  ...
  "water-heater": {
    ...
    goodExample: {
      src: pgPath("systems", "water-heater", "good"),
      ...
      fallbackSrc: [pgPath("systems", "water-heater", "good", "jpg")],
    },
    badExample: {
      src: pgPath("systems", "water-heater", "bad"),
      alt: "Water heater photo that is cropped and dark",
      caption: "Cropped — top connections cut off, dark image, no label visible.",
      fallbackSrc: [pgPath("systems", "water-heater", "bad", "jpg")],
    },
    tips: [
  ...
  "swimming-pool": {
    ...
    goodExample: {
      src: pgPath("interior", "swimming-pool", "good"),
      ...
      fallbackSrc: [pgPath("interior", "swimming-pool", "good", "jpg")],
    },
    badExample: {
      src: pgPath("interior", "swimming-pool", "bad"),
      ...
      fallbackSrc: [pgPath("interior", "swimming-pool", "bad", "jpg")],
    },
    tips: [
  ...
  "pool-fence": {
    ...
    goodExample: {
      src: pgPath("interior", "pool-fence", "good"),
      ...
      fallbackSrc: [pgPath("interior", "pool-fence", "good", "jpg")],
    },
    badExample: {
      src: pgPath("interior", "pool-fence", "bad"),
      ...
      fallbackSrc: [pgPath("interior", "pool-fence", "bad", "jpg")],
    },
    tips: [
      "Landscape orientation preferred.",
